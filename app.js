...
function paintSchoolOriginal(){
 ...
 // A linked PDF is reported by pdf_material; while it is present the older picture/DOCX draft, its status and its learning-record entry are hidden entirely, even if a stale untyped draft already reads ready.
