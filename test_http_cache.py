...
def check():
    with tempfile.TemporaryDirectory(prefix='synthetic-http-cache-') as folder:
        ...
        files = ('index.html', 'app.js', 'reading.js', 'calendar.js', 'child-access.js',
                 'learning.js', 'study.js', 'homework-input.js', 'settings.js', 'guided.js', 'teachers.js', 'goals.js', 'startup.js', 'ui.css', 'learning.css', 'study.css', 'homework-input.css', 'teachers.css', 'growth-world.js',
        ...
        with patch.multiple(app, ROOT=root, DATA=data, DB=data / 'family.sqlite3'), patch.dict(os.environ, {
            ...
            try:
                ...
                names = ('app.js', 'reading.js', 'calendar.js', 'child-access.js', 'learning.js', 'study.js', 'homework-input.js', 'settings.js', 'guided.js', 'teachers.js', 'goals.js')
